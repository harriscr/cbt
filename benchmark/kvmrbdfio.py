...
class KvmRbdFio(Benchmark):
    ...
    def __init__(self, archive_dir, cluster, config):
        ...
        self.run_dir = '%s/client_ra-%08d/op_size-%08d/concurrent_procs-%03d/iodepth-%03d/%s' % (self.run_dir, int(self.client_ra), int(self.op_size), int(self.total_procs), int(self.iodepth), self.mode)
